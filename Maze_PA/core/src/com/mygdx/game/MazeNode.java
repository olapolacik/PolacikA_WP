...
//    public static final int north = 0; //POLNOC
//    public static final int south = north + 1;  //1 POLUDNIE
//    public static final int east = south + 1; //2 wschod
//    public static final int west = east + 1; //3  zachod
//
//
//
...
//    // If there is no neighbor, it's a wall.
//    if (neighbor == null) {
//        return true;
//    }
//
//    // If the neighbor is not in the same tree or is not the predecessor of this node,
//    // or if this node is not in the same tree or is not the predecessor of the neighbor,
//    // then it's a wall.
//    return neighbor.predecessor != this && this.predecessor != neighbor;
//}
//
//
